...
namespace Unity.Ai.Assistant.Protocol.Model
{
    ...
    internal partial class ValidationErrorLocInner : AbstractOpenAPISchema
    {
        ...
        {
            return AbstractOpenAPISchema.Serialize(this.ActualInstance, ValidationErrorLocInner.SerializerSettings);
        }
        ...
        public static ValidationErrorLocInner FromJson(string jsonString)
        {
            ...
            try
            {
                newValidationErrorLocInner = new ValidationErrorLocInner(AbstractOpenAPISchema.Deserialize<int>(jsonString, ValidationErrorLocInner.SerializerSettings));
            ...
            try
            {
                newValidationErrorLocInner = new ValidationErrorLocInner(AbstractOpenAPISchema.Deserialize<string>(jsonString, ValidationErrorLocInner.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newValidationErrorLocInner;
            }
            catch (Exception exception)
