...
namespace Unity.Ai.Assistant.Protocol.Client
{
    ...
    internal class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.0.0a102";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.0.0a102/csharp");
            BasePath = "http://localhost";
            DefaultHeaders = new ConcurrentDictionary<string, string>();
            DynamicHeaders = new ConcurrentDictionary<string, Func<string>>();
        ...
        public Configuration(IDictionary<string, Func<string>> dynamicHeaders)
        {
        ...
        public virtual IDictionary<string, Func<string>> DynamicHeaders { get; set; }
        ...
        {
            string report = "C# SDK (Unity.Ai.Assistant.Protocol) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.0.0a102\n";
            report += "    SDK Package Version: 2.0.0a102\n";
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            Dictionary<string, Func<string>> dynamicHeaders = first.DynamicHeaders.ToDictionary(kvp =>kvp.Key, kvp => kvp.Value);

            foreach (var kvp in second.ApiKey) apiKey[kvp.Key] = kvp.Value;
            foreach (var kvp in second.ApiKeyPrefix) apiKeyPrefix[kvp.Key] = kvp.Value;
            foreach (var kvp in second.DefaultHeaders) defaultHeaders[kvp.Key] = kvp.Value;
            foreach (var kvp in second.DynamicHeaders) dynamicHeaders[kvp.Key] = kvp.Value;
