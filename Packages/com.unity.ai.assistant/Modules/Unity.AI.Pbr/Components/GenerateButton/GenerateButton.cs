...
namespace Unity.AI.Pbr.Components
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.ai.assistant/modules/Unity.AI.Pbr/Components/GenerateButton/GenerateButton.uxml";
        ...
        void OnGenerate()
        {
            AIAssistantAnalytics.ReportUITriggerLocalGenerateContentEvent("Material", this.GetState().SelectPrompt(this), this.GetState().SelectNegativePrompt(this));
