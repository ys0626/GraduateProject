...
namespace Unity.AI.Generators.IO.Utilities
{
    ...
    ///
    /// Self-contained copy of the same resolver in Unity.AI.Toolkit.Accounts
    /// (UUM-146339) — this assembly cannot reference that one. Consolidating the
    /// copies is a tracked follow-up.
    /// </summary>
    static class ProxyResolver
    {
        // System.Environment is fully qualified: an in-scope Unity `Environment` type may shadow it.
