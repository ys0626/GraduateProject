    ...
    Dictionary with results ('success', 'message', 'data').";
        ...
        private static System.Collections.Generic.List<MetadataReference> GetCompilationReferences()
        {
            ...
            try
            {
                ...
                // Core .NET assemblies
                references.Add(MetadataReference.CreateFromFile(AssemblyUtils.GetAssemblyPath(typeof(object)))); // mscorlib/System.Private.CoreLib
                references.Add(MetadataReference.CreateFromFile(AssemblyUtils.GetAssemblyPath(typeof(System.Linq.Enumerable)))); // System.Linq
                references.Add(MetadataReference.CreateFromFile(AssemblyUtils.GetAssemblyPath(typeof(System.Collections.Generic.List<>)))); // System.Collections

                // Unity assemblies
                try
                {
                    references.Add(MetadataReference.CreateFromFile(AssemblyUtils.GetAssemblyPath(typeof(UnityEngine.Debug)))); // UnityEngine
                }
                catch (Exception ex)
                {
                ...
                try
                {
                    references.Add(MetadataReference.CreateFromFile(AssemblyUtils.GetAssemblyPath(typeof(UnityEditor.Editor)))); // UnityEditor
                }
                catch (Exception ex)
                {
