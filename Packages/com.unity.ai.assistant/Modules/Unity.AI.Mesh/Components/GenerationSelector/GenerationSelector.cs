...
namespace Unity.AI.Mesh.Components
{
    ...
    partial class GenerationSelector : VisualElement
    {
        ...
        readonly Button m_MeshSettingsButton;
        ...
        public GenerationSelector()
        {
            ...
            m_MeshSettingsButton = this.Q<Button>("mesh-settings-button");
            m_MeshSettingsButton.clicked += () =>
            {
                this.GetStoreApi().Dispatch(GenerationSettingsActions.openMeshSettingsWindow, this);
            };
            this.Use(state => state.SelectMeshSettingsButtonVisible(this), m_MeshSettingsButton.SetShown);
        }
