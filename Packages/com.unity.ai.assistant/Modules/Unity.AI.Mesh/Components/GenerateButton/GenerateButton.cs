...
namespace Unity.AI.Mesh.Components
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.ai.assistant/modules/Unity.AI.Mesh/Components/GenerateButton/GenerateButton.uxml";
        ...
        void OnGenerate()
        {
            AIAssistantAnalytics.ReportUITriggerLocalGenerateContentEvent("Mesh", this.GetState().SelectPrompt(this), this.GetState().SelectNegativePrompt(this));
