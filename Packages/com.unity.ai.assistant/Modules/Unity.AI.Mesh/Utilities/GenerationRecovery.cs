...
namespace Unity.AI.Mesh.Services.Utilities
{
    ...
    record InterruptedDownloadData : IInterruptedDownloadData
    {
        ...
        public ImmutableStringList jobIds { get => ids; set => ids = value; }
    }
    ...
    static class GenerationRecovery
    {
        ...
        public static void AddInterruptedDownload(DownloadMeshesData data) => AddInterruptedDownload(new InterruptedDownloadData
        {
            asset = data.asset,
        ...
        public static void RemoveInterruptedDownload(DownloadMeshesData data) => RemoveInterruptedDownload(new InterruptedDownloadData
        {
            asset = data.asset,
            ids = new ImmutableStringList(data.jobIds.Select(id => id.ToString())),
            taskId = data.progressTaskId,
        ...
        /// </summary>
        public static string interruptedDownloadsFilePath { get; set; } = "Library/AI.Mesh/InterruptedDownloads.json";
