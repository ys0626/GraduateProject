...
{
    [FilePath("UserSettings/AI.Mesh/MeshGeneratorSettings.asset", FilePathAttribute.Location.ProjectFolder)]
    class MeshGeneratorSettings : ScriptableSingleton<MeshGeneratorSettings>
    {
        [SerializeField]
