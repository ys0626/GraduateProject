...
namespace Unity.AI.Animate.Components
{
    ...
    {
        const string k_Uxml = "Packages/com.unity.ai.assistant/modules/Unity.AI.Animate/Components/GenerateButton/GenerateButton.uxml";
        ...
        void OnGenerate()
        {
            AIAssistantAnalytics.ReportUITriggerLocalGenerateContentEvent("Animate", this.GetState().SelectPrompt(this), this.GetState().SelectNegativePrompt(this));
