...
namespace Unity.AI.Animate.Services.Stores.Slices
{
    static class SessionSlice
    {
        ...
        {
            var settings = AnimateGeneratorSettings.instance.session;
            ...
            store.CreateSlice(
                ...
                extraReducers => extraReducers
                    .AddCase(AppActions.init).With((_, payload) =>
                    {
                        ...
                        foreach (var kvp in AnimateGeneratorSettings.instance.session.settings.lastSelectedModels)
                        {
                        ...
                        mergedState.settings.previewSettings.sizeFactor = AnimateGeneratorSettings.instance.session.settings.previewSettings.sizeFactor;
