...
namespace Unity.AI.Sound.Services.Utilities
{
    ...
    static class GenerationRecovery
    {
        ...
        public static void AddInterruptedDownload(DownloadAudioData data) => AddInterruptedDownload(new InterruptedDownloadData
        {
            asset = data.asset,
        ...
        public static void RemoveInterruptedDownload(DownloadAudioData data) => RemoveInterruptedDownload(new InterruptedDownloadData
            {
                asset = data.asset,
                ids = new ImmutableStringList(data.jobIds.Select(id => id.ToString())),
                taskId = data.progressTaskId,
        ...
        /// </summary>
        public static string interruptedDownloadsFilePath { get; set; } = "Library/AI.Sound/InterruptedDownloads.json";
