...
{
    static partial class HFDownloader
    {
        ...
        static string GetFileUrl(string repoId, string revision, string filename, string? endpoint = null)
        {
            if (endpoint is null)
            {
        ...
        static IDictionary<string, string> BuildHFHeaders(string? token = null, bool isWriteAction = false,
            IDictionary<string, string>? userAgent = null)
        {
        ...
        static string GetHttpUserAgentStr(IDictionary<string, string> userAgent)
        {
        ...
        static string GetTokenToSend(string token)
        {
            // TODO: deal with token cache here.
            return token;
        }

        static void ValidateTokenToSend(string token, bool isWriteAction)
        {
            if (isWriteAction)
            {
